...
fun WalenjeTextStyle(textType: TextType): TextStyle {
  return when (textType) {
    ...
    TextType.TitleBase -> MaterialTheme.typography.titleMedium
    ...
    TextType.LabelBase -> MaterialTheme.typography.labelMedium
    TextType.LabelSmall -> MaterialTheme.typography.labelSmall
  }
}
